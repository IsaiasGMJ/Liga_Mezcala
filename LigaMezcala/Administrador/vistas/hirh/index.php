    ...
    <div class="container-fluid bg-primary py-5 px-0" style="margin-bottom: 90px;">
        <div class="row mx-0 align-items-center">
            <div class="col-lg-6 px-md-5 text-center text-lg-left">
                <h1 class="display-2 text-uppercase mb-3">Descubre la nueva forma de gestionar los Recursos Humanos.</h1>
                <p class="text-dark mb-4">Potencia tu empresa con nuestro software de gestión de RH. ¡Únete a la evolución!</p>
